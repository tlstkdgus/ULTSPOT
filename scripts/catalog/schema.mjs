...
export const schema = {
  ...
  places: tab('place_id', 'place_id name_ko name_en category city district address_ko floor operating_status source_ids', 'address_en neighborhood map_url latitude longitude coordinate_source_id price_amount currency accessibility language_support payment_support visit_minutes_estimate image_asset_id'),
  events: tab('event_id', 'event_id title_ko title_en event_type place_id organizer_name organizer_type start_date end_date timezone status reservation_status admission_condition source_ids', 'reservation_url booking_start booking_end overseas_booking_conditions price_amount currency age_condition series_id image_asset_id'),
  ...
  assets: tab('asset_id', 'asset_id original_url rights_holder permission_status evidence_reference', 'allowed_use attribution expires_at file_reference alt_ko alt_en source_page_url rights_checked_at reviewer_alias modification_note'),
