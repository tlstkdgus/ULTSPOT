...
export const schema = {
  artists: tab('artist_id', 'artist_id entity_type name_ko name_en official_url source_ids', 'aliases birthday_mm_dd debut_date anniversary_date fandom_name image_asset_id'),
