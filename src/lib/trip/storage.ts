...
export function isPersonalEvent(value: unknown): value is FanEvent {
  ...
  if (['title_ja', 'do_ja', 'get_ja', 'area_ja', 'title_zh', 'do_zh', 'get_zh', 'area_zh', 'translation_review', 'title_ko', 'do_ko', 'get_ko', 'area_ko', 'image_asset_id', 'transit', 'participation'].some(key => value[key] !== undefined)) return false;
